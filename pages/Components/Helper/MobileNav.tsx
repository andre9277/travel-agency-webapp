...
const MobileNav = ({ nav, closeNav }: Props) => {
  const navAnimation = nav ? "translate-x-0" : "translate-x-[-100%]"; //trade x for y if to change navbar rotation
  return (
    <div
      className={`fixed ${navAnimation} transform transiton-all duration-300 top-0 left-0 right-0 bottom-0 z-[10000] bg-[#200f31]`}
    >
